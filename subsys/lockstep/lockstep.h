...
_Static_assert(sizeof(struct cubs2_lockstep_shared) == 176,
...
_Static_assert(offsetof(struct cubs2_lockstep_shared, pwm) == 80, "CUBS2 PWM ABI offset mismatch");
_Static_assert(offsetof(struct cubs2_lockstep_shared, attitude) == 128,

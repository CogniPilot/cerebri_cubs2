...
foreach(_var
    CUBS2_RUMOCA_VERSION
    CUBS2_RUMOCA_BIN_DIR
    CUBS2_RUMOCA_INSTALL_SCRIPT_URL
    CUBS2_RUMOCA_INSTALL_SCRIPT_SHA256)
...
file(MAKE_DIRECTORY "${CUBS2_RUMOCA_BIN_DIR}")
set(_install_script "${CUBS2_RUMOCA_BIN_DIR}/install-rumoca-${CUBS2_RUMOCA_VERSION}.sh")
file(DOWNLOAD
  "${CUBS2_RUMOCA_INSTALL_SCRIPT_URL}"
  "${_install_script}"
  EXPECTED_HASH "SHA256=${CUBS2_RUMOCA_INSTALL_SCRIPT_SHA256}"
  TLS_VERIFY ON
...
if(NOT _download_code EQUAL 0)
  message(FATAL_ERROR
    "Failed to download Rumoca installer from ${CUBS2_RUMOCA_INSTALL_SCRIPT_URL}: "
    "${_download_message}"
  )
endif()
...
execute_process(
  COMMAND "${BASH_EXECUTABLE}" "${_install_script}"
          --version "${CUBS2_RUMOCA_VERSION}"
          --bin-dir "${CUBS2_RUMOCA_BIN_DIR}"
...
if(NOT _install_result EQUAL 0)
  message(FATAL_ERROR
    "Rumoca ${CUBS2_RUMOCA_VERSION} installer failed\n"
    "stdout:\n${_install_output}\n"
    "stderr:\n${_install_error}"
  )
endif()

set(_rumoca_executable "${CUBS2_RUMOCA_BIN_DIR}/rumoca")
...
string(REGEX REPLACE "^v" "" _rumoca_version_number "${CUBS2_RUMOCA_VERSION}")
execute_process(
